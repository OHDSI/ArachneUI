...
import ConditionsByIndexDetails from './ConditionsByIndexDetails';
            ...
            render={({ width, element }) => {
              ...
              treemap.render(
                ...
                height,
                {
                  ...
                  getcontent: (node) => {
                    return ReportUtils.getTreemapTooltipContent(node, treemap, 'Prevalence:', 'Number of People:', 'Relative Risk per Person:');
                  },
                  gettitle: (node) => {
