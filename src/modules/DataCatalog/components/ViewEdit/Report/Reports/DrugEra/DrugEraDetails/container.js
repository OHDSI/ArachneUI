...
import DrugEraDetails from './presenter';
...
function mapStateToProps(state) {
  ...
  let lengthOfEra = get(reportData, 'LENGTH_OF_ERA');
  ...
  if (lengthOfEra) {
    lengthOfEra = chart.prepareData(
      chart.normalizeDataframe(lengthOfEra),
...
export default connect(mapStateToProps, mapDispatchToProps)(DrugEraDetails);
