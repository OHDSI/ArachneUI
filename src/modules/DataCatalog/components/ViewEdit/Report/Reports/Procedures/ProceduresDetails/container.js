...
function mapStateToProps(state) {
  ...
  let ageOfFirstOccurrence = get(reportData, 'AGE_AT_FIRST_OCCURRENCE');
  const proceduresByType = get(reportData, 'PROCEDURES_BY_TYPE');
  ...
  if (ageOfFirstOccurrence) {
    ageOfFirstOccurrence = chart.prepareData(ageOfFirstOccurrence, chart.chartTypes.BOXPLOT);
  }
