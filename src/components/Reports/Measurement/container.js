  ...
  constructor() {
    ...
    this.filePath = 'measurement';
		this.detailsCharts = {
			...
			measurementsByTypeChart: new donut(),
			ageOfFirstOccurrenceChart: new boxplot(),
			frequencyDistributionChart: new histogram(),
			recordsByUnit: new donut(),
      valuesRelativeToNorm: new donut(),
      upperLimitDistribution: new boxplot(),
      lowerLimitDistribution: new boxplot(),
      measurementValueDistribution: new boxplot(),
		};
  }

  getFilename(conceptId) {
    return `measurement_${conceptId}.json`;
  }
}
