...
import { Modal, Form, FormTextarea } from 'arachne-components';

require('./style.scss');

function ModalRejectSubmission(props) {
  const classes = new BEMHelper('invitation-reject-form');
  ...
  return (
    <Modal modal={props.modal} title="Reject invitation">
      <div {...classes()}>
        <p {...classes('preface')}>
